...
const BlogPosts = () => {
  const posts = [
    ...
    },
    {
      ...
      link:
        'https://blog.formpl.us/creating-a-simple-collapsible-sidebar-with-javascript-no-framework-required-af9f8265d156',
    },
    {
      id: 3,
      title: 'How to create an Image Uploader using React and Cloudinary',
      link:
        'https://medium.com/frontend-digest/how-to-create-an-image-uploader-using-react-and-cloudinary-5f07959723c4',
    },
    {
      id: 4,
