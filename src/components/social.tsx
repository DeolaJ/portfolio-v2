...
const Social: FC = () => (
  <SocialWrapper className="block w-full p-0 m-0 mb-8 list-none md:mb-0">
    ...
    <li className="inline-block w-5 sm:w-6 mx-2.5 sm:mx-4 md:mb-5 md:px-0 md:block">
      <a
        href="https://www.linkedin.com/in/adeola-j-adeyemo"
        target="_blank"
    ...
    <li className="inline-block w-5 sm:w-6 mx-2.5 sm:mx-4 md:mb-5 md:px-0 md:block">
      <a
        href="https://www.instagram.com/de.joe"
        target="_blank"
        rel="nofollow noopener noreferrer"
    ...
    <li className="inline-block w-5 sm:w-6 mx-2.5 sm:mx-4 md:mb-0 md:px-0 md:block">
      <a
